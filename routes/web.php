...
Route::get('/trips/note', [TripController::class, 'getNote'])->name('getAriportNote');
...
Route::get('/booking/trips/print', [TripBookingController::class, 'print'])->name('printTripBooking');
